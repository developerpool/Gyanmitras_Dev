...
{
    public class GyanmitrasFileHelper
    {
        /// <summary>
        /// 
        /// </summary>
       ...
       /// <returns></returns>
        ...
        public static ImageError CheckValidImage(HttpPostedFileBase file)
        {
            ...
            var isValidFile = GyanmitrasFileHelper.CheckUploadedFileExtensionForCalendars(fileExtension);
            if (!isValidFile)
            {
                return ImageError.InValidImage;
            }
            var isValidSize = GyanmitrasFileHelper.CheckUploadedFileSize(file.ContentLength);
            if (!isValidSize)
            {
        ...
        public static ImageError CheckValidFile(HttpPostedFileBase file)
        {
            ...
            if (fileName != null)
                ...
                return ImageError.InValidImage;
            var isValidFile = GyanmitrasFileHelper.CheckUploadedFileExtension(fileExtension);
            if (!isValidFile)
            {
                return ImageError.InValidImage;
            }
        ...
        public static ImageError CheckValidCalendarFile(HttpPostedFileBase file)
        {
            ...
            var isValidSize = GyanmitrasFileHelper.CheckUploadedCalendarFileSize(file.ContentLength);
            if (!isValidSize)
            {
                return ImageError.ImageSize;
            }
        ...
        public static ImageError CheckValidImageFile(HttpPostedFileBase file)
        {
            ...
            if (fileName != null)
                ...
                return ImageError.InValidImage;
            var isValidFile = GyanmitrasFileHelper.CheckUploadedImageFileExtension(fileExtension);
